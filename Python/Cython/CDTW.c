...
#define __PYX_HAVE__Python__Cython__CDTW
#define __PYX_HAVE_API__Python__Cython__CDTW
#include <omp.h>
#include <math.h>
 ...
 * 
 */
typedef __pyx_t_5numpy_int_t __pyx_t_6Python_6Cython_4CDTW_DINT_t;

/* "Python/Cython/CDTW.pyx":12
 * DFLOAT = np.float
 * ctypedef np.int_t DINT_t
 * ctypedef np.float_t DFLOAT_t             # <<<<<<<<<<<<<<
 * 
 * 
 */
typedef __pyx_t_5numpy_float_t __pyx_t_6Python_6Cython_4CDTW_DFLOAT_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'Python.Cython.CDTW' */
...
static float __pyx_f_6Python_6Cython_4CDTW_DTWDistance(__Pyx_memviewslice, __Pyx_memviewslice, double, __Pyx_memviewslice); /*proto*/
static float __pyx_f_6Python_6Cython_4CDTW_seqmin(__Pyx_memviewslice, int, int); /*proto*/
static float __pyx_f_6Python_6Cython_4CDTW_seqmax(__Pyx_memviewslice, int, int); /*proto*/
static CYTHON_INLINE int __pyx_f_6Python_6Cython_4CDTW_cmax(int, int); /*proto*/
static float __pyx_f_6Python_6Cython_4CDTW_LB_Keogh(__Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/
static __Pyx_memviewslice __pyx_f_6Python_6Cython_4CDTW_CNN_predict(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/
...
#define __Pyx_MODULE_NAME "Python.Cython.CDTW"
int __pyx_module_is_main_Python__Cython__CDTW = 0;

/* Implementation of 'Python.Cython.CDTW' */
...
static const char __pyx_k_CDTW_pyx[] = "CDTW.pyx";
...
static const char __pyx_k_NN_predict[] = "NN_predict";
...
static const char __pyx_k_Python_Cython_CDTW[] = "Python.Cython.CDTW";
...
static PyObject *__pyx_kp_s_CDTW_pyx;
...
static PyObject *__pyx_n_s_NN_predict;
static PyObject *__pyx_kp_u_Non_native_byte_order_not_suppor;
static PyObject *__pyx_n_b_O;
static PyObject *__pyx_kp_s_Out_of_bounds_on_buffer_access_a;
static PyObject *__pyx_n_s_PickleError;
static PyObject *__pyx_n_s_Python_Cython_CDTW;
...
static PyObject *__pyx_pf_6Python_6Cython_4CDTW_NN_predict(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x_train, __Pyx_memviewslice __pyx_v_y_train, __Pyx_memviewslice __pyx_v_x_test, int __pyx_v_w); /* proto */
...
static float __pyx_f_6Python_6Cython_4CDTW_DTWDistance(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, CYTHON_UNUSED double __pyx_v_w, __Pyx_memviewslice __pyx_v_DTW) {
  int __pyx_v_N;
  int __pyx_v_M;
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 */
  ...
  for (__pyx_t_2 = 1; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "Python/Cython/CDTW.pyx":25
 *     #cdef double[:,:] DTW = np.empty((N, M), dtype=float)
 *     for i in range(1, N):
 *         for j in range(1, M):             # <<<<<<<<<<<<<<
 *             tmp = x[i] - y[j]
 *             DTW[i][j] = tmp*tmp + min(DTW[i-1][j],
 */
    __pyx_t_3 = __pyx_v_M;
    for (__pyx_t_4 = 1; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      __pyx_v_j = __pyx_t_4;

      /* "Python/Cython/CDTW.pyx":26
 *     for i in range(1, N):
 *         for j in range(1, M):
 *             tmp = x[i] - y[j]             # <<<<<<<<<<<<<<
 *             DTW[i][j] = tmp*tmp + min(DTW[i-1][j],
 ...
 */
      __pyx_t_5 = __pyx_v_i;
      __pyx_t_6 = __pyx_v_j;
      __pyx_v_tmp = ((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_5 * __pyx_v_x.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_y.data + __pyx_t_6 * __pyx_v_y.strides[0]) ))));

      /* "Python/Cython/CDTW.pyx":28
 *             tmp = x[i] - y[j]
 *             DTW[i][j] = tmp*tmp + min(DTW[i-1][j],
 *                                       DTW[i-1][j-1],             # <<<<<<<<<<<<<<
 *                                       DTW[i][j-1])
 *     return DTW[N-1][M-1]
 */
      __pyx_t_7.data = __pyx_v_DTW.data;
      __pyx_t_7.memview = __pyx_v_DTW.memview;
...
__pyx_t_7.shape[0] = __pyx_v_DTW.shape[1];
__pyx_t_7.strides[0] = __pyx_v_DTW.strides[1];
    __pyx_t_7.suboffsets[0] = -1;

__pyx_t_8 = (__pyx_v_j - 1);
      __pyx_t_9 = (*((double *) ( /* dim=0 */ (__pyx_t_7.data + __pyx_t_8 * __pyx_t_7.strides[0]) )));
      __PYX_XDEC_MEMVIEW(&__pyx_t_7, 0);
      __pyx_t_7.memview = NULL;
      __pyx_t_7.data = NULL;

      /* "Python/Cython/CDTW.pyx":29
 *             DTW[i][j] = tmp*tmp + min(DTW[i-1][j],
 *                                       DTW[i-1][j-1],
 *                                       DTW[i][j-1])             # <<<<<<<<<<<<<<
 *     return DTW[N-1][M-1]
...
__pyx_t_10 = (__pyx_v_j - 1);
      __pyx_t_11 = (*((double *) ( /* dim=0 */ (__pyx_t_7.data + __pyx_t_10 * __pyx_t_7.strides[0]) )));
      __PYX_XDEC_MEMVIEW(&__pyx_t_7, 0);
      __pyx_t_7.memview = NULL;
      __pyx_t_7.data = NULL;

      /* "Python/Cython/CDTW.pyx":27
 *         for j in range(1, M):
 *             tmp = x[i] - y[j]
 *             DTW[i][j] = tmp*tmp + min(DTW[i-1][j],             # <<<<<<<<<<<<<<
 *                                       DTW[i-1][j-1],
...
__pyx_t_12 = __pyx_v_j;
      __pyx_t_13 = (*((double *) ( /* dim=0 */ (__pyx_t_7.data + __pyx_t_12 * __pyx_t_7.strides[0]) )));
      __PYX_XDEC_MEMVIEW(&__pyx_t_7, 0);
      __pyx_t_7.memview = NULL;
      __pyx_t_7.data = NULL;
...
__pyx_t_15 = __pyx_v_j;
      *((double *) ( /* dim=0 */ (__pyx_t_7.data + __pyx_t_15 * __pyx_t_7.strides[0]) )) = ((__pyx_v_tmp * __pyx_v_tmp) + __pyx_t_14);
      __PYX_XDEC_MEMVIEW(&__pyx_t_7, 0);
      __pyx_t_7.memview = NULL;
      __pyx_t_7.data = NULL;
    }
...
__pyx_t_16 = (__pyx_v_M - 1);
  __pyx_r = (*((double *) ( /* dim=0 */ (__pyx_t_7.data + __pyx_t_16 * __pyx_t_7.strides[0]) )));
  __PYX_XDEC_MEMVIEW(&__pyx_t_7, 0);
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_L1_error:;
  __PYX_XDEC_MEMVIEW(&__pyx_t_7, 0);
  __Pyx_WriteUnraisable("Python.Cython.CDTW.DTWDistance", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "Python/Cython/CDTW.pyx":35
 * @cython.wraparound(False)
 * @cython.nonecheck(False)
...
static float __pyx_f_6Python_6Cython_4CDTW_seqmin(__Pyx_memviewslice __pyx_v_s, int __pyx_v_begin, int __pyx_v_end) {
  int __pyx_v_i;
 ...
 *         if s[i] < minval:
 */
  __pyx_v_minval = NPY_INFINITY;

  /* "Python/Cython/CDTW.pyx":39
 *     cdef double minval
 *     minval = INFINITY
 *     for i in range(begin,end):             # <<<<<<<<<<<<<<
 *         if s[i] < minval:
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    __pyx_t_4 = (((*((double *) ( /* dim=0 */ (__pyx_v_s.data + __pyx_t_3 * __pyx_v_s.strides[0]) ))) < __pyx_v_minval) != 0);
    if (__pyx_t_4) {

      /* "Python/Cython/CDTW.pyx":41
 *     for i in range(begin,end):
 *         if s[i] < minval:
 *             minval = s[i]             # <<<<<<<<<<<<<<
 *     return minval
 ...
 */
      __pyx_t_5 = __pyx_v_i;
      __pyx_v_minval = (*((double *) ( /* dim=0 */ (__pyx_v_s.data + __pyx_t_5 * __pyx_v_s.strides[0]) )));
...
static float __pyx_f_6Python_6Cython_4CDTW_seqmax(__Pyx_memviewslice __pyx_v_s, int __pyx_v_begin, int __pyx_v_end) {
  int __pyx_v_i;
 ...
 *         if s[i] > maxval:
 */
  __pyx_v_maxval = (-NPY_INFINITY);

  /* "Python/Cython/CDTW.pyx":51
 *     cdef double maxval
 *     maxval = -INFINITY
 *     for i in range(begin,end):             # <<<<<<<<<<<<<<
 *         if s[i] > maxval:
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    __pyx_t_4 = (((*((double *) ( /* dim=0 */ (__pyx_v_s.data + __pyx_t_3 * __pyx_v_s.strides[0]) ))) > __pyx_v_maxval) != 0);
    if (__pyx_t_4) {

      /* "Python/Cython/CDTW.pyx":53
 *     for i in range(begin,end):
 *         if s[i] > maxval:
 *             maxval = s[i]             # <<<<<<<<<<<<<<
 *     return maxval
 ...
 */
      __pyx_t_5 = __pyx_v_i;
      __pyx_v_maxval = (*((double *) ( /* dim=0 */ (__pyx_v_s.data + __pyx_t_5 * __pyx_v_s.strides[0]) )));
...
static CYTHON_INLINE int __pyx_f_6Python_6Cython_4CDTW_cmax(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  int __pyx_t_1;
...
static CYTHON_INLINE int __pyx_f_6Python_6Cython_4CDTW_cmin(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  int __pyx_t_1;
  if (((__pyx_v_a <= __pyx_v_b) != 0)) {
    __pyx_t_1 = __pyx_v_a;
...
static float __pyx_f_6Python_6Cython_4CDTW_LB_Keogh(__Pyx_memviewslice __pyx_v_s1, __Pyx_memviewslice __pyx_v_s2, int __pyx_v_r) {
 ...
 */
  __pyx_v_N = (__pyx_v_s1.shape[0]);

  /* "Python/Cython/CDTW.pyx":73
 *     cdef int i
 *     cdef int N = s1.shape[0]
 *     cdef double LB_sum = 0             # <<<<<<<<<<<<<<
 *     for i in range(0, N-r):
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    __pyx_v_val = (*((double *) ( /* dim=0 */ (__pyx_v_s1.data + __pyx_t_3 * __pyx_v_s1.strides[0]) )));

    /* "Python/Cython/CDTW.pyx":76
 *     for i in range(0, N-r):
 *         val = s1[i]
 *         lower_bound=seqmin(s2,cmax(i-r, 0),i+r)             # <<<<<<<<<<<<<<
 *         upper_bound=seqmax(s2,cmax(i-r, 0),i+r)
 *         if i>upper_bound:
 */
    __pyx_v_lower_bound = __pyx_f_6Python_6Cython_4CDTW_seqmin(__pyx_v_s2, __pyx_f_6Python_6Cython_4CDTW_cmax((__pyx_v_i - __pyx_v_r), 0), (__pyx_v_i + __pyx_v_r));

    /* "Python/Cython/CDTW.pyx":77
 *         val = s1[i]
 *         lower_bound=seqmin(s2,cmax(i-r, 0),i+r)
 *         upper_bound=seqmax(s2,cmax(i-r, 0),i+r)             # <<<<<<<<<<<<<<
 *         if i>upper_bound:
 ...
 */
    __pyx_v_upper_bound = __pyx_f_6Python_6Cython_4CDTW_seqmax(__pyx_v_s2, __pyx_f_6Python_6Cython_4CDTW_cmax((__pyx_v_i - __pyx_v_r), 0), (__pyx_v_i + __pyx_v_r));

    /* "Python/Cython/CDTW.pyx":78
 *         lower_bound=seqmin(s2,cmax(i-r, 0),i+r)
 *         upper_bound=seqmax(s2,cmax(i-r, 0),i+r)
 *         if i>upper_bound:             # <<<<<<<<<<<<<<
 *             temp = val-upper_bound
 ...
 */
    __pyx_t_4 = ((__pyx_v_i > __pyx_v_upper_bound) != 0);
    if (__pyx_t_4) {

      /* "Python/Cython/CDTW.pyx":79
 *         upper_bound=seqmax(s2,cmax(i-r, 0),i+r)
 *         if i>upper_bound:
 *             temp = val-upper_bound             # <<<<<<<<<<<<<<
 *             LB_sum=LB_sum+temp*temp
 *         elif i<lower_bound:
 */
      __pyx_v_temp = (__pyx_v_val - __pyx_v_upper_bound);

      /* "Python/Cython/CDTW.pyx":80
 *         if i>upper_bound:
 *             temp = val-upper_bound
 *             LB_sum=LB_sum+temp*temp             # <<<<<<<<<<<<<<
 *         elif i<lower_bound:
 ...
 */
      __pyx_v_LB_sum = (__pyx_v_LB_sum + (__pyx_v_temp * __pyx_v_temp));
 ...
 *             LB_sum=LB_sum+temp*temp
 */
    __pyx_t_4 = ((__pyx_v_i < __pyx_v_lower_bound) != 0);
    if (__pyx_t_4) {

      /* "Python/Cython/CDTW.pyx":82
 *             LB_sum=LB_sum+temp*temp
 *         elif i<lower_bound:
 *             temp = val-lower_bound             # <<<<<<<<<<<<<<
 *             LB_sum=LB_sum+temp*temp
 *     return sqrt(LB_sum)
 */
      __pyx_v_temp = (__pyx_v_val - __pyx_v_lower_bound);

      /* "Python/Cython/CDTW.pyx":83
 *         elif i<lower_bound:
 *             temp = val-lower_bound
 *             LB_sum=LB_sum+temp*temp             # <<<<<<<<<<<<<<
 *     return sqrt(LB_sum)
...
static __Pyx_memviewslice __pyx_f_6Python_6Cython_4CDTW_CNN_predict(__Pyx_memviewslice __pyx_v_x_train, __Pyx_memviewslice __pyx_v_y_train, __Pyx_memviewslice __pyx_v_x_test, int __pyx_v_w) {
  __Pyx_memviewslice __pyx_v_predictions = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_closest_seq;
  int __pyx_v_N;
  CYTHON_UNUSED int __pyx_v_M;
  double __pyx_v_min_dist;
  double __pyx_v_dist;
  __Pyx_memviewslice __pyx_v_DTW = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_thread_number;
  ...
  __Pyx_RefNannySetupContext("CNN_predict", 0);

  /* "Python/Cython/CDTW.pyx":90
 * @cython.nonecheck(False)
 * cdef int[:] CNN_predict(double[:,:] x_train, int[:] y_train, double[:,:] x_test, int w):
 *     cdef int[:] predictions = np.empty(x_test.shape[0], dtype=int)             # <<<<<<<<<<<<<<
 *     cdef int i, j, closest_seq
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_x_test.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 90, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_v_M = (__pyx_v_x_test.shape[0]);

  /* "Python/Cython/CDTW.pyx":95
 *     cdef int M = x_test.shape[0]
 *     cdef double min_dist,dist
 *     cdef double[:,:,:] DTW = np.empty((mp.cpu_count(), x_test.shape[1], x_test.shape[1]), dtype=DFLOAT)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_empty); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_mp); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_cpu_count); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromSsize_t((__pyx_v_x_test.shape[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyInt_FromSsize_t((__pyx_v_x_test.shape[1])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_DFLOAT); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_2) < 0) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_3, __pyx_t_6); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_t_2);
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel private(__pyx_t_11, __pyx_t_12, __pyx_t_15, __pyx_t_17, __pyx_t_18) firstprivate(__pyx_t_13, __pyx_t_14, __pyx_t_16) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #ifdef WITH_THREAD
                    ...
                    #endif /* _OPENMP */
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_closest_seq) lastprivate(__pyx_v_dist) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j) lastprivate(__pyx_v_min_dist) lastprivate(__pyx_v_thread_number)
                    #endif /* _OPENMP */
                    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_10; __pyx_t_9++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            __pyx_v_closest_seq = ((int)0xbad0bad0);
                            __pyx_v_dist = ((double)__PYX_NAN());
                            __pyx_v_j = ((int)0xbad0bad0);
                            __pyx_v_min_dist = ((double)__PYX_NAN());
                            __pyx_v_thread_number = ((int)0xbad0bad0);

                            /* "Python/Cython/CDTW.pyx":98
 *     cdef int thread_number
 *     for i in prange(M, nogil=True):
 *         thread_number = openmp.omp_get_thread_num()             # <<<<<<<<<<<<<<
 *         min_dist = INFINITY
 *         for j in range(N):
 */
                            __pyx_v_thread_number = omp_get_thread_num();

                            /* "Python/Cython/CDTW.pyx":99
 *     for i in prange(M, nogil=True):
 *         thread_number = openmp.omp_get_thread_num()
 *         min_dist = INFINITY             # <<<<<<<<<<<<<<
 *         for j in range(N):
 ...
 */
                            __pyx_v_min_dist = NPY_INFINITY;

                            /* "Python/Cython/CDTW.pyx":100
 *         thread_number = openmp.omp_get_thread_num()
 *         min_dist = INFINITY
 *         for j in range(N):             # <<<<<<<<<<<<<<
 *             if LB_Keogh(x_test[i], x_train[j], 5) < min_dist:
 ...
 */
                              ...
                              {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_x_test.shape[0];
...
__pyx_t_14.data = __pyx_v_x_train.data;
                              __pyx_t_14.memview = __pyx_v_x_train.memview;
                              __PYX_INC_MEMVIEW(&__pyx_t_14, 0);
                              {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_j;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_x_train.shape[0];
...
__pyx_t_14.shape[0] = __pyx_v_x_train.shape[1];
__pyx_t_14.strides[0] = __pyx_v_x_train.strides[1];
    __pyx_t_14.suboffsets[0] = -1;

__pyx_t_15 = ((__pyx_f_6Python_6Cython_4CDTW_LB_Keogh(__pyx_t_13, __pyx_t_14, 5) < __pyx_v_min_dist) != 0);
 ...
 *                     min_dist = dist
 */
                                __pyx_t_14.data = __pyx_v_x_test.data;
                                __pyx_t_14.memview = __pyx_v_x_test.memview;
                                __PYX_INC_MEMVIEW(&__pyx_t_14, 0);
                                {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_x_test.shape[0];
...
__pyx_t_14.shape[0] = __pyx_v_x_test.shape[1];
__pyx_t_14.strides[0] = __pyx_v_x_test.strides[1];
    __pyx_t_14.suboffsets[0] = -1;
...
__pyx_t_16.data = __pyx_v_DTW.data;
                                __pyx_t_16.memview = __pyx_v_DTW.memview;
                                __PYX_INC_MEMVIEW(&__pyx_t_16, 0);
                                {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_thread_number;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_DTW.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_DTW.strides[0];
    if (0 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
...
__pyx_t_16.shape[0] = __pyx_v_DTW.shape[1];
__pyx_t_16.strides[0] = __pyx_v_DTW.strides[1];
    __pyx_t_16.suboffsets[0] = -1;

__pyx_t_16.shape[1] = __pyx_v_DTW.shape[2];
__pyx_t_16.strides[1] = __pyx_v_DTW.strides[2];
    __pyx_t_16.suboffsets[1] = -1;

__pyx_v_dist = __pyx_f_6Python_6Cython_4CDTW_DTWDistance(__pyx_t_14, __pyx_t_13, __pyx_v_w, __pyx_t_16);
                                __PYX_XDEC_MEMVIEW(&__pyx_t_14, 0);
                                __pyx_t_14.memview = NULL;
                                __pyx_t_14.data = NULL;
                                __PYX_XDEC_MEMVIEW(&__pyx_t_13, 0);
 ...
 * 
 */
                            __pyx_t_17 = __pyx_v_closest_seq;
                            __pyx_t_18 = __pyx_v_i;
                            *((int *) ( /* dim=0 */ (__pyx_v_predictions.data + __pyx_t_18 * __pyx_v_predictions.strides[0]) )) = (*((int *) ( /* dim=0 */ (__pyx_v_y_train.data + __pyx_t_17 * __pyx_v_y_train.strides[0]) )));
                            goto __pyx_L15;
                            __pyx_L8_error:;
                            {
                                #ifdef WITH_THREAD
                            ...
                            #endif /* _OPENMP */
                            {
                                __pyx_parallel_temp0 = __pyx_v_closest_seq;
                                __pyx_parallel_temp1 = __pyx_v_dist;
                                __pyx_parallel_temp2 = __pyx_v_i;
                                __pyx_parallel_temp3 = __pyx_v_j;
                                __pyx_parallel_temp4 = __pyx_v_min_dist;
                                __pyx_parallel_temp5 = __pyx_v_thread_number;
                            }
                            __pyx_L15:;
                            #ifdef _OPENMP
                    ...
                    #else
{
            ...
            if (__pyx_parallel_why) {
              __pyx_v_closest_seq = __pyx_parallel_temp0;
              __pyx_v_dist = __pyx_parallel_temp1;
              __pyx_v_i = __pyx_parallel_temp2;
              __pyx_v_j = __pyx_parallel_temp3;
              __pyx_v_min_dist = __pyx_parallel_temp4;
              __pyx_v_thread_number = __pyx_parallel_temp5;
 ...
 */
  __PYX_INC_MEMVIEW(&__pyx_v_predictions, 0);
 ...
 */
  ...
  __Pyx_AddTraceback("Python.Cython.CDTW.CNN_predict", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
/* Python wrapper */
static PyObject *__pyx_pw_6Python_6Cython_4CDTW_1NN_predict(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6Python_6Cython_4CDTW_1NN_predict = {"NN_predict", (PyCFunction)__pyx_pw_6Python_6Cython_4CDTW_1NN_predict, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6Python_6Cython_4CDTW_1NN_predict(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x_train = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_y_train = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_x_test = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_w;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("NN_predict (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x_train,&__pyx_n_s_y_train,&__pyx_n_s_x_test,&__pyx_n_s_w,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y_train)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("NN_predict", 1, 4, 4, 1); __PYX_ERR(0, 109, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_x_test)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("NN_predict", 1, 4, 4, 2); __PYX_ERR(0, 109, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_w)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("NN_predict", 1, 4, 4, 3); __PYX_ERR(0, 109, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "NN_predict") < 0)) __PYX_ERR(0, 109, __pyx_L3_error)
      }
    ...
    __pyx_v_x_train = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_x_train.memview)) __PYX_ERR(0, 109, __pyx_L3_error)
    __pyx_v_y_train = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1]); if (unlikely(!__pyx_v_y_train.memview)) __PYX_ERR(0, 109, __pyx_L3_error)
    __pyx_v_x_test = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2]); if (unlikely(!__pyx_v_x_test.memview)) __PYX_ERR(0, 109, __pyx_L3_error)
    __pyx_v_w = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_w == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 109, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("NN_predict", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 109, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("Python.Cython.CDTW.NN_predict", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6Python_6Cython_4CDTW_NN_predict(__pyx_self, __pyx_v_x_train, __pyx_v_y_train, __pyx_v_x_test, __pyx_v_w);
...
static PyObject *__pyx_pf_6Python_6Cython_4CDTW_NN_predict(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x_train, __Pyx_memviewslice __pyx_v_y_train, __Pyx_memviewslice __pyx_v_x_test, int __pyx_v_w) {
  __Pyx_memviewslice __pyx_v_predictions = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  PyObject *__pyx_t_6 = NULL;
  __Pyx_RefNannySetupContext("NN_predict", 0);

  /* "Python/Cython/CDTW.pyx":110
 * 
 * def NN_predict(double[:,:] x_train, int[:] y_train, double[:,:] x_test, int w):
 *     cdef int[:] predictions = CNN_predict(x_train, y_train, x_test, w)             # <<<<<<<<<<<<<<
 *     return np.asarray(predictions)
 */
  __pyx_t_1 = __pyx_f_6Python_6Cython_4CDTW_CNN_predict(__pyx_v_x_train, __pyx_v_y_train, __pyx_v_x_test, __pyx_v_w); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 110, __pyx_L1_error)
  __pyx_v_predictions = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "Python/Cython/CDTW.pyx":111
 * def NN_predict(double[:,:] x_train, int[:] y_train, double[:,:] x_test, int w):
 *     cdef int[:] predictions = CNN_predict(x_train, y_train, x_test, w)
 *     return np.asarray(predictions)             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_asarray); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 111, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_predictions, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 111, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_y_train, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "Python.Cython.CDTW.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "Python.Cython.CDTW.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "Python.Cython.CDTW.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "Python.Cython.CDTW._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_CDTW_pyx, __pyx_k_CDTW_pyx, sizeof(__pyx_k_CDTW_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_NN_predict, __pyx_k_NN_predict, sizeof(__pyx_k_NN_predict), 0, 0, 1, 1},
  {&__pyx_kp_u_Non_native_byte_order_not_suppor, __pyx_k_Non_native_byte_order_not_suppor, sizeof(__pyx_k_Non_native_byte_order_not_suppor), 0, 1, 0, 0},
  {&__pyx_n_b_O, __pyx_k_O, sizeof(__pyx_k_O), 0, 0, 0, 1},
  {&__pyx_kp_s_Out_of_bounds_on_buffer_access_a, __pyx_k_Out_of_bounds_on_buffer_access_a, sizeof(__pyx_k_Out_of_bounds_on_buffer_access_a), 0, 0, 1, 0},
  {&__pyx_n_s_PickleError, __pyx_k_PickleError, sizeof(__pyx_k_PickleError), 0, 0, 1, 1},
  {&__pyx_n_s_Python_Cython_CDTW, __pyx_k_Python_Cython_CDTW, sizeof(__pyx_k_Python_Cython_CDTW), 0, 0, 1, 1},
 ...
 *     return np.asarray(predictions)
 */
  __pyx_tuple__29 = PyTuple_Pack(5, __pyx_n_s_x_train, __pyx_n_s_y_train, __pyx_n_s_x_test, __pyx_n_s_w, __pyx_n_s_predictions); if (unlikely(!__pyx_tuple__29)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__29);
  __Pyx_GIVEREF(__pyx_tuple__29);
  __pyx_codeobj__30 = (PyObject*)__Pyx_PyCode_New(4, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__29, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_CDTW_pyx, __pyx_n_s_NN_predict, 109, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__30)) __PYX_ERR(0, 109, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initCDTW(void); /*proto*/
PyMODINIT_FUNC initCDTW(void)
#else
PyMODINIT_FUNC PyInit_CDTW(void); /*proto*/
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_CDTW(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("CDTW", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_Python__Cython__CDTW) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Python.Cython.CDTW")) {
      if (unlikely(PyDict_SetItemString(modules, "Python.Cython.CDTW", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_mp, __pyx_t_1) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "Python/Cython/CDTW.pyx":7
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DINT, __pyx_t_2) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "Python/Cython/CDTW.pyx":10
 * cimport numpy as np
 * DINT = np.int
 * DFLOAT = np.float             # <<<<<<<<<<<<<<
 * ctypedef np.int_t DINT_t
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_DFLOAT, __pyx_t_1) < 0) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     return np.asarray(predictions)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6Python_6Cython_4CDTW_1NN_predict, NULL, __pyx_n_s_Python_Cython_CDTW); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_NN_predict, __pyx_t_1) < 0) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "Python/Cython/CDTW.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 * import multiprocessing as mp
 * from cython.parallel import prange
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Python.Cython.CDTW", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Python.Cython.CDTW");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
